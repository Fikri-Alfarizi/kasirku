...
<head>
    ...
    <title>Login Kasir - Kasirku</title>
...
<body>
    <div class="left-section">
        ...
        <div class="content-wrapper">
            ...
            <p>Masuk ke aplikasi Kasirku untuk mengelola penjualan dan stok dengan mudah dan aman.</p>
        </div>
    </div>
    <div class="right-section">
        <div class="login-container">
            ...
            <form method="POST" action="/login" autocomplete="off">
                ...
                <input type="hidden" name="intended" value="/dashboard">
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" id="email" name="email" placeholder="Masukkan email" required value="{{ old('email') }}" autofocus>
                </div>
                <div class="form-group">
            ...
            <div class="social-login">
                <div class="social-btn google-btn" title="Login dengan Google">
                ...
                <div class="social-btn facebook-btn" title="Login dengan Facebook">
